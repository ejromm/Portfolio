...
export default function Film() {
    ...
    return (
        <div className='film-container'>
            ...
            <span className={isBold === 0 ? 'film-list-item bold' : 'film-list-item'}   onClick={() => changeVideo("https://www.youtube.com/embed/lHWnjtDrPFU",0)}>Wally x UpDating Client Sizzle (2023)</span>
            ...
            {isBold === 0 ? <iframe id='mobile-frame' width="394" height="700" src="https://www.youtube.com/embed/lHWnjtDrPFU" title="Wally x UpDating Client Sizzle (Mobile)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> : <iframe src={currentVideo} id='full-frame' frameborder="0" allow="autoplay; fullscreen; picture-in-picture"   title="current-video"></iframe> }
            </div>
